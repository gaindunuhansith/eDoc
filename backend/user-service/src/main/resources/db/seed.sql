...
(gen_random_uuid(), 'USR-PAT-16', 'Lehan Navaratne',        'lehanxp@gmail.com',              crypt('Password123', gen_salt('bf', 10)), '0788600016', 'PATIENT', true, true,  false, NOW() - INTERVAL '5 days',   NOW() - INTERVAL '1 day',    NULL);
