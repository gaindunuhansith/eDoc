...
public class PaymentController {
    ...
    public ResponseEntity<String> initiatePayment(@Valid @RequestBody InitiatePaymentRequest request) {
        return ResponseEntity.ok("initiate endpoint is working for appointmentId: " + request.getAppointmentId());
    }
